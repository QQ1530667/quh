...
#left I-I
ax.fill_between(p6x,p6y,q4y,color="gainsboro")
#right I-II
ax.fill_between(q1x,q1y,p2y,color="aquamarine")
#left I-II
ax.fill_between(p5x,p5y,q4y,color="aquamarine")
#right II-II
ax.fill_between(p2x,p2y,q2y,color="lightsalmon")
#left II-II
ax.fill_between(q3x,q3y,p5y,color="lightsalmon")
...
ax.text(tx,ty,"II-II",fontsize=16)
#region left II-II
tx=q3x[p]
ty=1/3*(2*q3y[p]+p5y[p])
ax.text(tx,ty,"II-II",fontsize=16)
#compute roots
g=0.01
E=g**(-1)*c
...
plt.savefig("./potential9/"+str(coefs)+".png")