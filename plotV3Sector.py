...
#color filling
#fill region I-I right
ax.fill_between(q0x, q0y, p1y,color='gainsboro')
#fill region left I-I
ax.fill_between(q3x,q3y,p4y,color="gainsboro")
#fill region right I-II
ax.fill_between(p1x,p1y,q1y,color="aquamarine")
#fill region left I-II
ax.fill_between(p4x,p4y,q2y,color="aquamarine")
...
tx=q0x[p]
ty=1/3*(2*q0y[p]+p1y[p])
ax.text(tx,ty,"I-I",fontsize=16)
#region left I-I
tx=q3x[p]
ty=1/3*(2*q3y[p]+p4y[p])
ax.text(tx,ty,"I-I",fontsize=16)
#region right I-II
tx=p1x[p]
...
plt.savefig("./potential3/"+str(coefs)+".png")